...
class SupervisedTrainer:
    ...
    def train(self):
        ...
        for epoch in range(self.config['epochs']):
            ...
            # Invoke early stopping callback if provided
            if self.early_stopping is not None:
                # Provide the metric based on monitor attribute
                metric = val_acc if self.early_stopping.monitor == 'val_accuracy' else val_loss
        ...
        # Restore best weights if early stopping requested it
        if self.early_stopping and self.early_stopping.restore_best_weights:
            ...
            print("Model weights restored to best checkpoint.")
